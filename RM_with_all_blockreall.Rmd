...
```
With this measure, no signficant effect were find, but the evidence was anecdotal in favor of the alternative hypothesis for the main effects and anecdotal in favor of the null for the interaction (Certainty:`r apa(c_mem_score_test_ANOVA, effect = "certainty", format = "rmarkdown")`, `r report_BF_and_error(c_b_mem_score_AVOVA[1])`; Predictiveness: `r apa(c_mem_score_test_ANOVA, effect = "predictiveness", format = "rmarkdown")`, `r report_BF_and_error(c_b_mem_score_AVOVA[2])`; interaction: `r apa(c_mem_score_test_ANOVA, effect = "certainty:predictiveness", format = "rmarkdown")`, `r report_BF_and_error(c_b_mem_score_AVOVA_int[1])` ). 
